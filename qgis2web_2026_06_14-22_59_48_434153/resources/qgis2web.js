...
map.getView().fit([11244892.437746, 26038.257844, 11437039.438507, 169130.527014], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tingkat Potensi Banjir Kabupaten Siak Tahun 2024</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_BatasAdministrasiKecamatan_3,
    colName: 'NAMOBJ',
    zoom: 10,
    collapsed: true,
    map: map,
